            ...
            if submit:
                if user_id and name:
                    ...
                    if is_valid:
                        ...
                        # dashboard_page()
                        # st.rerun()
                        # st.switch_page("agent_test4.py")
                        # # subprocess.Popen("streamlit run C:\Python\gpt_agent_2025_easyspub-main\gpt_agent_2025_easyspub-main\chap10\sec04\pages\test1.py")
